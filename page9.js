...
// Spin Checkbox
const spinButton = document.getElementById('spin-checkbox');
spinButton.addEventListener('click', function () {
    textElement.classList.toggle('spin-active');
});
...
document.getElementById('reset-button').addEventListener('click', function () {
    ...
    // Spin checkbox
    textElement.classList.remove('spin-active');
    spinButton.checked = false;
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Check if we're coming from page 10 
    if (document.referrer.includes('page10.html')) {
