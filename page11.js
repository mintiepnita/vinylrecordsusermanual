...
// Audio Functionality
const playFlickerButton = document.getElementById('play-needle-audio');
const vinylCrackAudio = document.getElementById('lowerneedle-audio');
...
document.addEventListener('DOMContentLoaded', function () {
    const container = document.querySelector('.container');
    // Check if we're coming from page 12 
    if (document.referrer.includes('page12.html')) {
