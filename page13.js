...
document.getElementById('reset-button').addEventListener('click', function () {
    ...
    document.getElementById('bg-color').value = '#ff27e9';
...
const preloadNextPage = new Image();
preloadNextPage.src = 'page3.html';
...
document.addEventListener('DOMContentLoaded', function () {
    const container = document.querySelector('.container');
    // Check if we're coming from page 14 
    if (document.referrer.includes('page14.html')) {
