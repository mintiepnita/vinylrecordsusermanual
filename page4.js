...
let isHolding = false;  // State to track if the button is in "holding" mode

holdButton.addEventListener('click', function () {
  if (!isHolding) {
    console.log('Applying animations...');
    textContainer.classList.add('tilt-animation');
    textContainer.classList.add('bounce-animation');
    holdButton.textContent = '💽 Holding...';
    isHolding = true;
  } else {
    console.log('Removing animations...');
    textContainer.classList.remove('tilt-animation');
    textContainer.classList.remove('bounce-animation');
...
document.getElementById('reset-button').addEventListener('click', function () {
  ...
  pickr1.setColor('#ff27e9');
  pickr2.setColor('#0088ff');
  ...
  document.getElementById('color').value = '#ff27e9';
  document.getElementById('special-char-color').value = '#0088ff';
...
document.addEventListener('DOMContentLoaded', function () {
  const container = document.querySelector('.container');
  // Check if we're coming from page 5 
  if (document.referrer.includes('page5.html')) {
